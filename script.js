...
const topics = {
  ...
  Mysql: {
    ...
    items: [
      ...
      { title: "Joins", file: "Mysql/module-8-joins" },
      { title: "Subqueries", file: "Mysql/module9-subqueries" },
      { title: "Views", file: "Mysql/module10-views" },
      { title: "Indexes", file: "Mysql/module11-indexes" },
      { title: "Normalization", file: "Mysql/module-12-normalization" },
      { title: "Transactions", file: "Mysql/module13-transactions" },
      { title: "Isolation Levels", file: "Mysql/module14-isolation-levels" },
      { title: "Locks & Deadlocks", file: "Mysql/module15-locks-deadlocks" },
      { title: "Stored Procedures", file: "Mysql/module16-stored-procedures" },
