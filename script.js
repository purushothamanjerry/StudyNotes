...
const topics = {
  ...
  Mysql: {
    ...
    duration: "25h",
    items: [
      { title: "Introduction to MySQL", file: "DBMS/Mysql/introduction" },
      { title: "SQL Language", file: "DBMS/Mysql/module2-sql-language" },
      { title: "Creating Databases & Tables", file: "DBMS/Mysql/module-3-creating-databases-tables" },
      { title: "CRUD Operations", file: "DBMS/Mysql/module-4-crud-operations" },
      { title: "Operators & Functions", file: "DBMS/Mysql/module5-operators-functions" },
      { title: "Aggregate Functions & GROUP BY", file: "DBMS/Mysql/module-6-aggregate-functions-groupby" },
      { title: "Constraints & Keys", file: "DBMS/Mysql/module-7-constraintsandKeys" },
      { title: "Joins", file: "DBMS/Mysql/module-8-joins" },
      { title: "Subqueries", file: "DBMS/Mysql/module9-subqueries" },
      { title: "Views", file: "DBMS/Mysql/module10-views" },
      { title: "Indexes", file: "DBMS/Mysql/module11-indexes" },
      { title: "Normalization", file: "DBMS/Mysql/module-12-normalization" },
      { title: "Transactions", file: "DBMS/Mysql/module13-transactions" },
      { title: "Isolation Levels", file: "DBMS/Mysql/module14-isolation-levels" },
      { title: "Locks & Deadlocks", file: "DBMS/Mysql/module15-locks-deadlocks" },
      { title: "Stored Procedures", file: "DBMS/Mysql/module16-stored-procedures" },
      { title: "Performance Tuning", file: "DBMS/Mysql/module-17-performance-tuning" },
      { title: "Database Security", file: "DBMS/Mysql/module18-database-security" },
      { title: "Concurrency", file: "DBMS/Mysql/module-19-concurrency" },
